...
def calculer_consommation(budget) -> None:
    ...
    Règles :
    - montant_consomme = somme des dépenses (montant < 0) sur la catégorie
      et le mois du budget, hors transferts.
    - taux_consommation = abs(montant_consomme) / montant_prevu * 100
...
def calculer_consommation_pour_flux(flux) -> None:
    ...
    Recalcule le budget correspondant si il existe.
    """
